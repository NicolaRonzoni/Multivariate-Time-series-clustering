...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 15 14:24:03 2021
...
#########TRAIN DATA##########
#import  train data
df= pd.read_csv("/Users/nronzoni/Downloads/Multivariate-Time-series-clustering-main/30min data&code/S1816 30min.csv") 
df
...
day_density=list(partition(48,normalized_density))
day_density
len(day_density)
...
#######TEST DATA ########
#import  test data
df_test= pd.read_csv("/Users/nronzoni/Downloads/Multivariate-Time-series-clustering-main/30min data&code/S1816 30min.csv") 
df_test
#treatment of flow variables 
...
day_density_test=list(partition(48,normalized_density_test))
day_density_test
...
km_dba = TimeSeriesKMeans(n_clusters=5, metric="softdtw", max_iter=5,max_iter_barycenter=5, random_state=0).fit(multivariate_time_series_train)
...
plt.title('soft-DTW similarity measure S60 detector')
...
#test days 2014
test_days=pd.date_range('4/1/2014', periods=122, freq='D')

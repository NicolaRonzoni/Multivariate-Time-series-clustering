...
#######TEST DATA ########
#import  test data
df_test= pd.read_csv("/Users/nicolaronzoni/Downloads/I35W_NB 30min 2013/S124.csv") 
df_test
#treatment of flow variables 
...
km_dba = TimeSeriesKMeans(n_clusters=3, metric="softdtw", max_iter=5,max_iter_barycenter=5, random_state=None).fit(multivariate_time_series_train)
...
plt.legend()
plt.subplot(2,2,2)
plt.plot(x,centroids[0][:,1],'r-', label = 'speed')
plt.xlabel('day')
plt.ylabel('speed')
plt.title('centroid speed k=1')
plt.legend()
plt.subplot(2,2,3)
...
plt.legend()
plt.subplot(2,2,4)
plt.plot(x,centroids[1][:,1],'r-', label = 'speed')
plt.xlabel('day')
plt.ylabel('speed')
plt.title('centroid speed k=0')
plt.legend()
plt.show()
...
plt.legend()
plt.subplot(3,2,6)
plt.plot(x,centroids[2][:,1],'r-', label = 'speed')
plt.xlabel('day')
plt.ylabel('speed')
plt.title('centroid speed k=0')
plt.legend()

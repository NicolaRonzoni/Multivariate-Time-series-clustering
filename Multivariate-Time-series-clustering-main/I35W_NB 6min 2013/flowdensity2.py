...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 17 10:37:19 2021
...
#########TRAIN DATA##########
#import  train data
df= pd.read_csv("/Users/nronzoni/Downloads/Multivariate-Time-series-clustering-main/I35W_NB 6min 2013/S61.csv") 
df
...
days_first=list(partition(240,first_train))
days_first
len(days_first)
...
len(second_train)
#for every day of the train set store the flow observations 
days_second=list(partition(240,second_train))
days_second
len(days_second)
#from list to multidimensional array 
...
#######TEST DATA ########
#import  test data
df_test= pd.read_csv("/Users/nronzoni/Downloads/Multivariate-Time-series-clustering-main/I35W_NB 6min 2013/S124.csv") 
df_test
#treatment of the first variable 
...
len(first_test)
#for every day of the train set store the flow observations 
days_first_test=list(partition(240,first_test))
days_first_test
len(days_first_test)
#from list to multidimensional array 
...
len(second_test)
#for every day of the train set store the flow observations 
days_second_test=list(partition(240,second_test))
days_second_test

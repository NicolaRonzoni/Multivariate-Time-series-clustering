...
#######TEST DATA ########
#import  test data
df_test= pd.read_csv("/Users/nicolaronzoni/Downloads/I35W_NB 30min 2013/S60test.csv") 
df_test
#treatment of flow variables 
...
#test days 2014
before= np.full(shape=90,fill_value=3,dtype=np.int)
before
after= np.full(shape=153,fill_value=3,dtype=np.int)
after
#concatenate arrays 
